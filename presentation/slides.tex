...
% 9. Sample Keyframes
\begin{frame}{Qualitative Results: Sample Demo Keyframes}
    \begin{block}{Cars Demo Video (T=126)}
        \centering
        \includegraphics[width=0.3\textwidth]{../results/demo_outputs/cars/keyframes/bilstm/kf_0018.jpg}
        \includegraphics[width=0.3\textwidth]{../results/demo_outputs/cars/keyframes/bilstm/kf_0066.jpg}
        \includegraphics[width=0.3\textwidth]{../results/demo_outputs/cars/keyframes/bilstm/kf_0103.jpg}
    \end{block}
    \begin{block}{AI Robot Demo Video (T=33)}
        \centering
        \includegraphics[width=0.3\textwidth]{../results/demo_outputs/ai_robot/keyframes/bilstm/kf_0004.jpg}
        \includegraphics[width=0.3\textwidth]{../results/demo_outputs/ai_robot/keyframes/bilstm/kf_0007.jpg}
    \end{block}
\end{frame}
